...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager
            .beginTransaction()
            .add(film.search.filmssearch.R.id.fragment_placeholder, MainFragment())
    ...
    private fun initFilmsDB() {
        ...
        allFilms = mutableListOf(
            Film(
                film.search.filmssearch.R.drawable.brave,
                getString(film.search.filmssearch.R.string.brave_title),
                getString(film.search.filmssearch.R.string.brave_description)
            ),
            Film(
                film.search.filmssearch.R.drawable.cars,
                getString(film.search.filmssearch.R.string.cars_title),
                getString(film.search.filmssearch.R.string.cars_description)
            ),
            Film(
                film.search.filmssearch.R.drawable.finding_nemo,
        ...
        binding.bottomNavigation.setOnItemSelectedListener {
            when (it.itemId) {
                film.search.filmssearch.R.id.favorites -> {
                    supportFragmentManager
                        .beginTransaction()
                        .replace(film.search.filmssearch.R.id.fragment_placeholder, FavoritesFragment())
                        .addToBackStack(null)
                        .commit()
                    true
                }
...
//        val posterTransitionName = TRANSITION_NAME + POSTER + position
//        val descriptionTransitionName = TRANSITION_NAME + DESCRIPTION + position
        supportFragmentManager
            .beginTransaction()
            .replace(R.id.fragment_placeholder, fragment)
            .addToBackStack(FRAGMENT_TAG)
//            .addSharedElement(filmItemBinding.poster, posterTransitionName)
//            .addSharedElement(filmItemBinding.description, descriptionTransitionName)
            .commit()
